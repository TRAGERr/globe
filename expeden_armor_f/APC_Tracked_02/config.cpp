class CfgPatches
{
	class Armor_Globe_APC_Tracked_02
	{
	...
	class APC_Tracked_02_base_F: Tank_F
	{
		class Sounds
		{
			soundSetsInt[]=
			{
				...
				"APC_Tracked_02_Engine_INT_Burst_SoundSet",
			...
			soundSetsExt[]=
			{
				...
				"APC_Tracked_02_Engine_EXT_Burst_SoundSet",
...
class CfgSoundSets
{
	class APC_Tracked_02_Engine_EXT_Burst_SoundSet
	{
		soundShaders[]=
		{
			"APC_Tracked_02_Engine_EXT_Burst_SoundShader"
		};
	...
	class APC_Tracked_02_Engine_INT_Burst_SoundSet
	{
		soundShaders[]=
		{
			"APC_Tracked_02_Engine_INT_Burst_SoundShader"
		};
		playTrigger="(thrust * (angVelocity factor[0.1,0]) * (speed factor[5,4.9]) - 0.1)";
		posOffset[]={0,0,0};
		distanceFilter="softVehiclesDistanceFreqAttenuationFilter";
...
{
	class APC_Tracked_02_Engine_EXT_Burst_SoundShader
	{
		samples[]=
		{
			
			{
				"A3\Sounds_F\vehicles2\armor\APC_Tracked_02\APC_Tracked_02_Engine_EXT_Burst01",
				1
			},
			
			{
				"A3\Sounds_F\vehicles2\armor\APC_Tracked_02\APC_Tracked_02_Engine_EXT_Burst02",
				1
			},
			
			{
				"A3\Sounds_F\vehicles2\armor\APC_Tracked_02\APC_Tracked_02_Engine_EXT_Burst03",
				1
			}
		};
		frequency=1.05;
		range="1*150";
		volume="engineOn * 0.7 * 0.6 * (rpm factor[0,10])";
	};
	class APC_Tracked_02_Engine_INT_Burst_SoundShader
	{
		samples[]=
		{
			
			{
				"A3\Sounds_F\vehicles2\armor\APC_Tracked_02\APC_Tracked_02_Engine_INT_Burst01",
				1
			},
			
			{
				"A3\Sounds_F\vehicles2\armor\APC_Tracked_02\APC_Tracked_02_Engine_INT_Burst02",
				1
			},
			
			{
				"A3\Sounds_F\vehicles2\armor\APC_Tracked_02\APC_Tracked_02_Engine_INT_Burst03",
				1
			}
		};
		frequency=1.05;
