...
switch (_type) do
{
	case ("Tablet_02_G_DiaryImagesAltis_random"):
	{
		_object setObjectTextureGlobal [0, selectRandom _imagesAltis];
	};

	case ("Tablet_02_G_DiaryImagesStratis_random"):
	{
		_object setObjectTextureGlobal [0, selectRandom _imagesStratis];
	};

	case ("Tablet_02_G_DiaryImagesAltisStratis_random"):
	{
		_object setObjectTextureGlobal [0, selectRandom (_imagesAltis + _imagesStratis)];
	};
};