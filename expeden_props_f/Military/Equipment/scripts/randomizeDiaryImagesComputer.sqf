...
switch (_type) do
{
	case ("MultiScreenComputer_01_G_DiaryImagesAltis_random"):
	{
		_object setObjectTextureGlobal [1, selectRandom _imagesAltis];
		_object setObjectTextureGlobal [2, selectRandom _imagesAltis];
		_object setObjectTextureGlobal [3, selectRandom _imagesAltis];
	};

	case ("MultiScreenComputer_01_G_DiaryImagesStratis_random"):
	{
		_object setObjectTextureGlobal [1, selectRandom _imagesStratis];
		_object setObjectTextureGlobal [2, selectRandom _imagesStratis];
		_object setObjectTextureGlobal [3, selectRandom _imagesStratis];
	};

	case ("MultiScreenComputer_01_G_DiaryImagesAltisStratis_random"):
	{
		_object setObjectTextureGlobal [1, selectRandom (_imagesAltis + _imagesStratis)];
		_object setObjectTextureGlobal [2, selectRandom (_imagesAltis + _imagesStratis)];
		_object setObjectTextureGlobal [3, selectRandom (_imagesAltis + _imagesStratis)];
	};
};