/*
	...
	Description:
		Random texture for Laws of War's photoframe 
...
[
	"\a3\characters_f\data\ui\icon_U_Citizen_CA.paa",
	"\a3\structures_f_aow\Civilian\Gallery_01\Data\env_galleryBuilding_room_co.paa",
	"\a3\missions_f_beta\data\img\monitors\tablet_fd14_2_co.paa",
...
//--- random wooden frame color
_object setObjectTextureGlobal [1, format ["#(rgb,8,8,3)color(%1,%2,%3,%4)", random 1, random 1, random 1, random 1]];
