	...
	class VehicleList
	{
		class GoKart
		{
			...
			arguments[]=
			{
				...
				{
					"STR_A3_dlc_karts_fm_headline_kart"
				},
				
				{
					"STR_A3_CFGVEHICLES_KART_01_BASE_F_LIBRARY0"
				}
			};
	...
	class WeaponList
	{
		class FlareGun
		{
			...
			arguments[]=
			{
				...
				{
					"STR_A3_dlc_karts_fm_headline_flaregun"
				},
				
				{
					"STR_A3_CFGWEAPONS_HGUN_PISTOL_SIGNAL_F_LIBRARY0"
				}
			};
