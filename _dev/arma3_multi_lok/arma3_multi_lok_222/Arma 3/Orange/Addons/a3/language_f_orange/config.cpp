...
class CfgHints
{
	class ExplosivesList
	{
		class APERSMineDispenser
		{
			...
			arguments[]=
			{
				...
				{
					"STR_A3_CfgMagazines_APERSMineDispenser_Mag0"
				},
				
				{
					"STR_A3_CfgMagazines_APERSMineDispenser_Mag_Library0"
				}
			};
		...
		class TrainingMine
		{
			...
			arguments[]=
			{
				...
				{
					"STR_A3_CfgMagazines_TrainingMine_Mag0"
				},
				
				{
					"STR_A3_CfgMagazines_TrainingMine_Mag_Library0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
			dlc=571710;
		...
		class UXO
		{
			...
			arguments[]=
			{
				...
				{
					"STR_A3_Orange_CfgHints_UXO_displayName"
				},
				
				{
					"STR_A3_Orange_CfgHints_UXO_description"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
			dlc=571710;
	...
	class VehicleList
	{
		class Van_02
		{
			...
			arguments[]=
			{
				...
				{
					"STR_A3_Orange_CfgHints_Van_02_displayName"
				},
				
				{
					"STR_A3_CfgVehicles_Van_02_Base_Library0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
			dlc=571710;
		...
		class UAV_06
		{
			...
			arguments[]=
			{
				...
				{
					"STR_A3_CfgVehicles_C_IDAP_UAV_06_F0"
				},
				
				{
					"STR_A3_CfgVehicles_UAV_06_base_F_Library0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
			dlc=571710;
		...
		class UAV_06_AntiMine
		{
			...
			arguments[]=
			{
				...
				{
					"STR_A3_CfgVehicles_C_IDAP_UAV_06_antimine_F0"
				},
				
				{
					"STR_A3_CfgVehicles_UAV_06_antimine_base_F_Library0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
			dlc=571710;
	...
	class PremiumContent
	{
		class PremiumOrange
		{
			...
			arguments[]=
			{
				...
				{
					"STR_A3_Orange_CfgMods_overview"
				},
				"""<img size='9' shadow='0' image='A3\Data_F_Orange\Images\orange_fm_overview_co' />""",
			...
			class Hint
			{
				...
				arguments[]=
				{
					...
					"""<img size='7' shadow='0' image='A3\Data_F_Orange\Images\orange_fm_overview_co' />"""
				};
				image="\a3\data_f_orange\logos\arma3_orange_icon_hint_ca.paa";
			};
		};
		class DLCStrategy
		{
			...
			arguments[]=
			{
				"""https://www.bistudio.com/blog/roadmap-14-15-dlc-strategy-blog"""
			};
	...
	class InternationalHumanitarianLaw
	{
		...
		class Overview
		{
			...
			arguments[]=
			{
				...
				{
					"STR_A3_Orange_CfgHints_IHL_Overview_arg11"
				}
			};
	...
	class CombatantCodeOfConduct
	{
		...
		class ProtectiveSymbols
		{
			...
			arguments[]=
			{
				"""<img size='1.5' image = 'A3\Data_f\Flags\flag_rcrystal_co' />"""
			};
	...
	class Common
	{
		...
		class Renegade
		{
			...
			arguments[]=
			{
				...
				{
					"STR_A3_Orange_CfgHints_Renegade_arg11"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
			logicalOrder=14;
	...
	class Weapons
	{
		...
		class MineDispensers
		{
			...
			arguments[]=
			{
				...
				{
					"STR_A3_Orange_CfgHints_MineDispensers_arg11"
				}
			};
		...
		class Minesweep
		{
			...
			arguments[]=
			{
				...
				{
					"STR_A3_Orange_CfgHints_Minesweep_arg14"
				},
				"format [""color = '%1'"", (['IGUI', 'ERROR_RGB'] call BIS_fnc_displayColorGet) call bis_fnc_colorRGBAtoHTML]"
			};
			class HintVisual
			{
	...
	class Tactics
	{
		class Leaflets
		{
			...
			arguments[]=
			{
				...
				{
					"STR_A3_Orange_CfgHints_Leaflets_arg13"
				}
			};
	...
	class Command
	{
		class CombatModes
		{
			...
			arguments[]=
			{
				...
				{
					"STR_A3_Orange_CfgHints_CombatModes_arg12"
				},
				
				{
					"STR_A3_Orange_CfgHints_CombatModes_arg13"
				},
				
				{
					"STR_A3_Orange_CfgHints_CombatModes_arg14"
				},
				
				{
					"STR_A3_Orange_CfgHints_CombatModes_arg15"
				}
			};
