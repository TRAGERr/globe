	...
	class Helicopters
	{
		...
		class HeliPitch
		{
			...
			class HeliPitch_sub3
			{
				...
				arguments[]=
				{
					...
					"format [""<img size='5' align='center' image = '\a3\Ui_f\data\GUI\Cfg\Hints\Heli_control_pitch_ca.paa'/>""]"
				};
			};
		...
		class HeliYaw
		{
			...
			arguments[]=
			{
				...
				"format [""<img size='5' align='center' image = '\a3\Ui_f\data\GUI\Cfg\Hints\Heli_tail_rotor_ca.paa'/>""]"
			};
			logicalOrder=8;
			class HeliYaw_sub1
			{
		...
		class HeliGroundEffect
		{
			...
			arguments[]=
			{
				...
				"format [""<img size='5' align='center' image = '\a3\Ui_f\data\GUI\Cfg\Hints\Heli_ground_effect_ca.paa'/>""]"
			};
			logicalOrder=10;
	...
	class VehicleList
	{
		class Huron
		{
			...
			arguments[]=
			{
				...
				{
					"STR_A3_HURON_TITLE_F0"
				},
				
				{
					"STR_A3_HURON_DESC_F0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
			dlc=304380;
