	...
	class PremiumContent
	{
		class PremiumTank
		{
			...
			arguments[]=
			{
				...
				{
					"$STR_A3_cfgmods_tank_overview0"
				},
				"""<img size='9' shadow='0' image='A3\Data_F_tank\Images\tank_fm_overview_co' />""",
			...
			class Hint
			{
				...
				arguments[]=
				{
					...
					"""<img size='7' shadow='0' image='A3\Data_F_tank\Images\tank_fm_overview_co' />"""
				};
				image="\a3\data_f_tank\logos\arma3_tank_icon_hint_ca.paa";
			};
		};
