	...
	class VehicleList
	{
		class SDVinfo
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgvehicles_sdv_base0"
				},
				
				{
					"str_a3_cfgvehicles_sdv_base_library0"
				}
			};
		...
		class blueforApcWheel
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgvehicles_b_apc_wheeled_01_cannon"
				},
				
				{
					"str_a3_cfgvehicles_apc_wheeled_01_library0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
		...
		class blueforApcTrack
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgvehicles_b_apc_tracked_01_base0"
				},
				
				{
					"str_a3_cfgvehicles_apc_tracked_01_base_library0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
		...
		class gaMrap
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgvehicles_mrap_03_base0"
				},
				
				{
					"str_a3_cfgvehicles_mrap_03_base_library0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
		...
		class opfor_apc_wheel
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgvehicles_o_apc_wheeled_02_rcws"
				},
				
				{
					"str_a3_CfgVehicles_apc_wheeled_02_library0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
		...
		class opforApcTrack
		{
			...
			arguments[]=
			{
				...
				{
					"STR_A3_CfgVehicles_APC_Tracked_02_0"
				},
				
				{
					"STR_A3_CfgVehicles_APC_Tracked_02_lib0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
		...
		class bluforSquadTransport
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgvehicles_b_truck_01"
				},
				
				{
					"str_a3_cfgvehicles_truck_01_base_library0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
		...
		class squadTransport
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgvehicles_c_truck_02_dump0"
				},
				
				{
					"str_a3_cfgvehicles_truck_02_lib"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
		...
		class bluforTransportHeli
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgvehicles_heli_transport_01_base_f0"
				},
				
				{
					"str_a3_cfgvehicles_heli_transport_01_base_f_armory0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
			vehicle="B_Heli_Transport_01_F";
			modelScale=0.55000001;
			logicalOrder=42;
		};
		class bluforAttackHeli
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgvehicles_b_heli_attack_01"
				},
				
				{
					"STR_A3_Heli_Attack_01_lib"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
		...
		class opforAttackHeli
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgvehicles_heli_attack_02_base0"
				},
				
				{
					"str_a3_cfgvehicles_heli_attack_02_base_library0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
			vehicle="O_Heli_Attack_02_F";
			modelScale=0.64999998;
			logicalOrder=26;
		};
		class gaTransport
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgvehicles_heli_transport_02_Base0"
				},
				
				{
					"str_a3_heli_transport_02_lib"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
	...
	class WeaponList
	{
		class gaRifle
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgweapons_arifle_mk200"
				},
				
				{
					"str_a3_cfgweapons_arifle_mk20_library0"
				}
			};
		...
		class titanshort
		{
			...
			arguments[]=
			{
				...
				{
					"str_cfgweapons_launch_mprl_short_f0"
				},
				
				{
					"STR_A3_cfgWeapons_launch_MPRL_short_Library0"
				}
			};
		...
		class titanlong
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgweapons_launch_mprl0"
				},
				
				{
					"str_a3_cfgweapons_launch_mprl_library0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Launcher_ca.paa";
		...
		class bluforsmg
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgweapons_smg_010"
				},
				
				{
					"str_a3_cfgweapons_hgun_smg_01_library0"
				}
			};
		...
		class opforsmg
		{
			...
			arguments[]=
			{
				...
				{
					"STR_A3_CfgWeapons_SMG_020"
				},
				
				{
					"str_a3_cfgweapons_SMG_02_library0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Rifles_ca.paa";
			weapon="SMG_02_F";
		...
		class gapistol1
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgweapons_hgun_acpc2_f0"
				},
				
				{
					"STR_A3_CfgWeapons_hgun_ACPC2_Library0"
				}
			};
		...
		class opforAutomatic
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgweapons_lmg_zafir_f0"
				},
				
				{
					"str_a3_cfgweapons_lmg_zafir_f_library0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Automatic_ca.paa";
			weapon="LMG_Zafir_F";
