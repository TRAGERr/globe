	...
	class VehicleList
	{
		class gaMbt
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgvehicles_i_mbt_03_cannon_f0"
				},
				
				{
					"str_a3_cfgvehicles_mbt_03_base_f_library0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
		...
		class gaApcTracked
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgvehicles_i_apc_tracked_03_cannon_f0"
				},
				
				{
					"str_a3_cfgvehicles_apc_tracked_03_base_f_library0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
		...
		class gaLightHeli
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgvehicles_i_heli_light_03_f0"
				},
				
				{
					"str_a3_cfgvehicles_i_heli_light_03_f_armory0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
