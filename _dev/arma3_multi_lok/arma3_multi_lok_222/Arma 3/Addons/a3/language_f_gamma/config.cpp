	...
	class UAV
	{
		...
		class Types
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgvehicles_ugv_01_base0"
				},
				
				{
					"str_a3_cfgvehicles_uav_01_base0"
				},
				
				{
					"str_a3_cfgvehicles_uav_02_base0"
				}
			};
		...
		class Connection
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgweapons_items_uavterminal"
				},
				...
				{
					"str_useract_uav_openuavterminal"
				},
				...
				{
					"str_useract_uav_uavterminalmakeconnection"
				},
				
				{
					"str_a3_rscdisplayavterminal_avt_takecontrol"
				}
			};
	...
	class VehicleList
	{
		class UGV
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgvehicles_ugv_01_base_library0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
		...
		class UAVrotor
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgvehicles_uav_01_base_library0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
			vehicle="B_UAV_01_F";
		...
		class UAVfixedwing
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgvehicles_uav_02_base_armory0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
		...
		class motorBoat
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgvehicles_boat_civil_01_base0"
				},
				
				{
					"str_a3_cfgvehicles_boat_civil_01_base_library0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
		...
		class Truck
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgvehicles_c_van_01"
				},
				
				{
					"str_a3_cfgvehicles_van_01_base_library0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
		...
		class bluforMbt
		{
			...
			arguments[]=
			{
				...
				{
					"STR_A3_CfgVehicles_MBT_01_cannon_base_F0"
				},
				
				{
					"STR_A3_CfgVehicles_MBT_01_cannon_base_F_Library0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
		...
		class gaApcWheel
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgvehicles_apc_wheeled_03_wapc0"
				},
				
				{
					"str_a3_cfgvehicles_apc_wheeled_03_wapc_library0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
		...
		class opforMbt
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgvehicles_mbt_02_base0"
				},
				
				{
					"str_a3_cfgvehicles_mbt_02_base_library0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
		...
		class bluforHeavyArty
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgvehicles_mbt_01_arty_base0"
				},
				
				{
					"str_a3_cfgvehicles_mbt_01_arty_base_library0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
		...
		class bluforRocketArty
		{
			...
			arguments[]=
			{
				...
				{
					"STR_A3_CfgVehicles_B_MBT_01_MLRS0"
				},
				
				{
					"STR_A3_CfgVehicles_B_MBT_01_MLRS_Library0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
		...
		class opforHeavyArty
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgvehicles_MBT_02_Arty_base0"
				},
				
				{
					"STR_A3_CfgVehicles_MBT_02_Arty_Library0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
		...
		class galightTransportOffroad
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgvehicles_offroad_base0"
				},
				
				{
					"str_a3_cfgvehicles_offroad_base_library0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
		...
		class galightTransportCar
		{
			...
			arguments[]=
			{
				...
				{
					"STR_A3_CfgVehicles_Car_Base_Library0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
		...
		class galightTransportSuv
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgvehicles_suv_base0"
				},
				
				{
					"str_a3_cfgvehicles_suv_base_library0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
			vehicle="C_SUV_01_F";
		...
		class gaFixedwing
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgvehicles_o_plane_fighter_03"
				},
				
				{
					"str_a3_cfgvehicles_o_plane_fighter_03_cas_library0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
	...
	class WeaponList
	{
		class staticHMG
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgvehicles_hmg_01_base0"
				},
				
				{
					"str_a3_cfgvehicles_hmg_01_base_armory0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
			logicalOrder=14;
		...
		class staticGMG
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgvehicles_gmg_01_base0"
				},
				
				{
					"str_a3_cfgvehicles_gmg_01_base_armory0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
			logicalOrder=15;
		...
		class gasmg
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgweapons_hgun_pdw20000"
				},
				
				{
					"str_a3_cfgweapons_hgun_pdw2000_library0"
				}
			};
