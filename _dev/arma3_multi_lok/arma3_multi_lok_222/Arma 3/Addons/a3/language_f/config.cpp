...
class CfgHints
{
	...
	class Command
	{
		...
		class Commandbar
		{
			...
			arguments[]=
			{
				"format [""color = '%1'"",(((configfile >> 'CfgInGameUI' >> 'CommandBar' >> 'UnitInfo' >> 'UnitCombatMode' >> 'colorGreen') call bis_fnc_colorConfigToRGBA) call bis_fnc_colorRGBAtoHTML)]",
				"format [""color = '%1'"",(((configfile >> 'CfgInGameUI' >> 'CommandBar' >> 'UnitInfo' >> 'UnitStatus' >> 'colorWounded') call bis_fnc_colorConfigToRGBA) call bis_fnc_colorRGBAtoHTML)]",
	...
	class ExplosivesList
	{
		...
		class atmine
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgmagazines_mine0"
				},
				
				{
					"STR_A3_cfgMagazines_Mine_Library0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
			logicalOrder=3;
		...
		class apmine
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgmagazines_classicminerangemagazine_library0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
			logicalOrder=2;
		...
		class apboundingmine
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgmagazines_bouncingminerangemagazine0"
				},
				
				{
					"str_a3_cfgmagazines_bouncingminerangemagazine_library0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
			logicalOrder=1;
		...
		class slammine
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgmagazines_directionalminerangemagazine_library0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
			logicalOrder=8;
		...
		class claymore
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgmagazines_directionalmineremotemagazine0"
				},
				
				{
					"str_a3_cfgmagazines_directionalmineremotemagazine_library0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
			logicalOrder=4;
		...
		class explosivecharge
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgmagazines_democharge0"
				},
				
				{
					"str_a3_cfgmagazines_democharge_library0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
			logicalOrder=5;
		...
		class explosivesatchel
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgmagazines_pipebomb0"
				},
				
				{
					"str_a3_cfgmagazines_pipebomb_library0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
			logicalOrder=6;
		...
		class navalmooredmine
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgvehicles_underwaterminerange0"
				},
				
				{
					"str_a3_cfgvehicles_underwaterminerange_library0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
			logicalOrder=10;
		...
		class navalbotommine
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgvehicles_underwaterminerangeab0"
				},
				
				{
					"str_a3_cfgvehicles_underwaterminerangeab_library0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
			logicalOrder=9;
		...
		class navalshallowmine
		{
			...
			arguments[]=
			{
				...
				{
					"STR_A3_CFGVEHICLES_UNDERWATERMINEPDM0"
				},
				
				{
					"STR_A3_CFGVEHICLES_UNDERWATERMINEPDM_LIBRARY0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
			logicalOrder=11;
	...
	class Vehicle
	{
		...
		class VehicGuided
		{
			...
			arguments[]=
			{
				...
				"format [""<img size='1.5' color = '%1' align='left' image = '%2'/>"",(((configfile >> 'CfgInGameUI' >> 'Cursor' >> 'Targeting' >> 'Seeker' >> 'color') call bis_fnc_colorConfigToRGBA) call bis_fnc_colorRGBAtoHTML),getText(configfile >> 'CfgInGameUI' >> 'Cursor' >> 'Targeting' >> 'Seeker' >> 'texture')]",
				"format [""<img size='1.5' color = '%1' align='left' image = '%2'/>"",(((configfile >> 'CfgInGameUI' >> 'Cursor' >> 'Targeting' >> 'Seeker' >> 'color') call bis_fnc_colorConfigToRGBA) call bis_fnc_colorRGBAtoHTML),getText(configfile >> 'CfgInGameUI' >> 'Cursor' >> 'Targeting' >> 'Seeker' >> 'texture')]",
				"format [""<img size='1.5' color = '%1' align='left' image = '%2'/>"",(((configfile >> 'CfgInGameUI' >> 'Cursor' >> 'Targeting' >> 'SeekerLocked' >> 'color') call bis_fnc_colorConfigToRGBA) call bis_fnc_colorRGBAtoHTML),getText(configfile >> 'CfgInGameUI' >> 'Cursor' >> 'Targeting' >> 'SeekerLocked' >> 'texture')]",
				"format [""<img size='1.5' color = '%1' align='left' image = '%2'/>"",(((configfile >> 'CfgInGameUI' >> 'Cursor' >> 'Targeting' >> 'SeekerNoLos' >> 'color') call bis_fnc_colorConfigToRGBA) call bis_fnc_colorRGBAtoHTML),getText(configfile >> 'CfgInGameUI' >> 'Cursor' >> 'Targeting' >> 'SeekerNoLos' >> 'texture')]"
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
			logicalOrder=15;
		};
	...
	class VehicleList
	{
		...
		class AssaultBoat
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgvehicles_boat_armed_01_base0"
				},
				
				{
					"str_a3_cfgvehicles_boat_armed_01_base_library0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
		...
		class LightTransportBoat
		{
			...
			arguments[]=
			{
				...
				{
					"STR_A3_CfgVehicles_Rubber_duck_base0"
				},
				
				{
					"str_a3_cfgvehicles_rubber_duck_base_library0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
		...
		class bluforMrap
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgvehicles_mrap_01_base0"
				},
				
				{
					"str_a3_cfgvehicles_mrap_01_base_library0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
		...
		class opforMrap
		{
			...
			arguments[]=
			{
				...
				{
					"str_A3_cfgvehicles_o_mrap_02_f0"
				},
				
				{
					"STR_A3_CfgVehicles_mrap_02_Base_Library0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
		...
		class miscTransportQuad
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgvehicles_quadbike_base_f0"
				},
				
				{
					"str_a3_cfgvehicles_quadbike_base_f_library0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
		...
		class bluforLightHeli
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgvehicles_heli_light_01_base0"
				},
				
				{
					"STR_A3_CFGVEHICLES_B_HELI_LIGHT_01_ARMORY1"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
		...
		class opforLightHeli
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgvehicles_heli_light_02_base_f0"
				},
				
				{
					"STR_A3_cfgvehicles_heli_light_02_lib"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
	...
	class WeaponList
	{
		...
		class portableMortar1
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgvehicles_mortar_01_base0"
				},
				
				{
					"str_a3_cfgvehicles_mortar_01_base_library0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
			weapon="";
		...
		class bluforRifle
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgweapons_arifle_xmx0"
				},
				
				{
					"str_a3_cfgweapons_arifle_xmx_library0"
				}
			};
		...
		class opforRifle
		{
			...
			arguments[]=
			{
				...
				{
					"STR_A3_CfgWeapons_arifle_Katiba_F_Library0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Rifle_ca.paa";
		...
		class bluforSpecShort
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgweapons_arifle_trg210"
				},
				
				{
					"str_a3_cfgweapons_arifle_trg21_gl_library0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Rifle_ca.paa";
		...
		class UnderwaterRifle
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgweapons_arifle_sdar0"
				},
				
				{
					"str_a3_cfgweapons_arifle_sdar_library0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Rifle_ca.paa";
		...
		class opforAutomatic
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgweapons_lmg_mk2000"
				},
				
				{
					"str_a3_cfgweapons_lmg_mk200_library0"
				}
			};
		...
		class bluforLauncher
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgweapons_launch_nlaw0"
				},
				
				{
					"str_a3_cfgweapons_launch_nlaw_library0"
				}
			};
		...
		class opforLauncher
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgweapons_launch_law0"
				},
				
				{
					"str_a3_cfgweapons_launch_law_library0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Launcher_ca.paa";
			modelScale=0.60000002;
		...
		class opforAntimat
		{
			...
			arguments[]=
			{
				...
				{
					"STR_A3_CfgWeapons_srifle_GM60"
				},
				
				{
					"str_a3_cfgweapons_srifle_gm6_library0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Ranged_ca.paa";
			modelScale=0.60000002;
		...
		class bluforAntimat
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgweapons_srifle_lrr0"
				},
				
				{
					"str_a3_cfgweapons_srifle_lrr_library0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Ranged_ca.paa";
			modelScale=0.40000001;
		...
		class bluforpistol1
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgweapons_hgun_p070"
				},
				
				{
					"str_a3_cfgweapons_hgun_p07_library0"
				}
			};
		...
		class opforpistol1
		{
			...
			arguments[]=
			{
				...
				{
					"str_cfgweapons_hgun_rook40_f0"
				},
				
				{
					"str_a3_cfgweapons_hgun_rook40_library0"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Handgun_ca.paa";
