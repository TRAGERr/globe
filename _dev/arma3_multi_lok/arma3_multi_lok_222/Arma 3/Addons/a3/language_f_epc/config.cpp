	...
	class VehicleList
	{
		class blueforFixedwing
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgvehicles_b_plane_cas_01_f0"
				},
		...
		class opforFixedwing
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgvehicles_o_plane_cas_02_f0"
				},
		...
		class opforSquadTransport
		{
			...
			arguments[]=
			{
				...
				{
					"str_a3_cfgvehicles_o_truck_03_transport_f0"
				},
		...
		class bluforMbtUP
		{
			...
			arguments[]=
			{
				...
				{
					"STR_A3_CfgVehicles_B_MBT_01_TUSK_F0"
				},
				
				{
					"STR_A3_sfgvehicles_b_mbt_01_tusk_f_library"
				}
			};
			image="\a3\ui_f\data\gui\cfg\hints\Miss_icon_ca.paa";
