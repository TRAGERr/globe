...
sleep 0.5;
if (speed _plane > _arrestMaxAllowedSpeed ) exitWith
{
	EXIT_CODE;
	// _plane say3D "Land_Carrier_01_wire_snap_sound";
	[_plane, ["Land_Carrier_01_wire_snap_sound", 1100, 1.3, 0, 0, true]] remoteExecCall ["say3D"];
};
// _plane say3D "Land_Carrier_01_wire_trap_sound";
[_plane, ["Land_Carrier_01_wire_trap_sound", 1100, 1.3, 0, 0, true]] remoteExecCall ["say3D"];
