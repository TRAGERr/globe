...
params [["_ejectionSeat",objNull]]; if (isNull _ejectionSeat) exitWith {};
private _pilot = (crew _ejectionSeat) param [0, objNull]; if (isNull _pilot || {!local _pilot}) exitWith {};


_ejectionSeat setPhysicsCollisionFlag false;
moveOut _pilot;
