...
ambient[]={2,2,2,1};
diffuse[]={0.44999999,0.41999999,0.40000001,1};
...
class Stage1
{
	texture="a3\characters_f_oldman\heads\data\m_sick_white_16_nohq.paa";
	uvSource="tex";
	class uvTransform
	{
		aside[]={1,0,0};
...
class Stage2
{
	texture="a3\characters_f_oldman\heads\data\m_sick_white_mc.paa";
	uvSource="tex";
	class uvTransform
	{
		aside[]={1,0,0};
...
class Stage5
{
	texture="a3\characters_f_epb\heads\data\m_white_16_smdi.paa";
	uvSource="tex";
	class uvTransform
	{
		aside[]={1,0,0};
